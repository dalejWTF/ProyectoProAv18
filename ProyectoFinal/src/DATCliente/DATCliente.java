...
public class DATCliente {
    ...
    public ResultSet IdDireccionAgregada() throws ClassNotFoundException, SQLException {
        ...
        String sql = "SELECT MAX(id) AS id FROM direccion";
        return s.executeQuery(sql);
    }
    ...
    public PreparedStatement EditarUsuario(Usuario usuario) throws ClassNotFoundException, SQLException {
        PreparedStatement ps = null;
    ...
    public PreparedStatement EliminarDireccion(Direccion direccion) throws ClassNotFoundException, SQLException{
        PreparedStatement ps=null;
    ...
    public PreparedStatement EliminarUsuario(Usuario usuario) throws ClassNotFoundException, SQLException{
        PreparedStatement ps=null;
